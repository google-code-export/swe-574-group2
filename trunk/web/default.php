		...
		downloadUrl("markerInfo.php", function(data) {
			...
			for ( var i = 0; i < markers.length; i++) {
				...
				var point = new google.maps.LatLng(parseFloat(markers[i]
						...
						.getAttribute("lng")));
				var html = "<b>Kayıt Id'si:</b> " + entryId
						+ "<br/> ''" + comment + "''";
...
// 		    });
		...
		selectParent.change(function() {
			...
			else
			{
				selectChild.empty();
				selectChild.append(
			        $('<option></option>').val(0).html("Tamamı")
			    );
...
<body>
	...
	<p style="height: 20px;"></p>
	<div>
		<a href="new.php" style="font-weight:bold; text-decoration: underline;">Bulunduğum lokasyona yeni giriş</a>
		&nbsp;&nbsp;||&nbsp;&nbsp;
		<a href="#" style="font-weight:bold; text-decoration: underline;">Seçeceğim lokasyona yeni giriş</a>
	</div>
	<p style="height: 20px"></p>
</body>
