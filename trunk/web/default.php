...
<body>
	...
	<div>
		<a href="new.php"
			style="font-weight: bold; text-decoration: underline;">Bulunduğum
			lokasyona yeni giriş</a> &nbsp;&nbsp;||&nbsp;&nbsp; <a href="new_manual.php"
			style="font-weight: bold; text-decoration: underline;">Seçeceğim
			lokasyona yeni giriş</a>
	</div>
	<p style="height: 20px"></p>
</body>
